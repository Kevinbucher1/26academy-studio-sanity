...
var defaultCodeModes = [
  {
    name: "groq",
    loader: () => import("./dist-KTYXG7PO.js").then(({ javascriptLanguage }) => javascriptLanguage)
  },
  {
    name: "javascript",
    loader: () => import("./dist-KTYXG7PO.js").then(({ javascript }) => javascript({ jsx: false }))
  },
  {
    name: "jsx",
    loader: () => import("./dist-KTYXG7PO.js").then(({ javascript }) => javascript({ jsx: true }))
  },
  {
    name: "typescript",
    loader: () => import("./dist-KTYXG7PO.js").then(
  ...
  { name: "php", loader: () => import("./dist-YXSK4DDR.js").then(({ php }) => php()) },
  { name: "sql", loader: () => import("./dist-BCG5DBCP.js").then(({ sql }) => sql()) },
  {
    name: "mysql",
    loader: () => import("./dist-BCG5DBCP.js").then(({ sql, MySQL }) => sql({ dialect: MySQL }))
  },
  { name: "json", loader: () => import("./dist-J26WGPI4.js").then(({ json }) => json()) },
  {
    name: "markdown",
    loader: () => import("./dist-HWOWKQXV.js").then(({ markdown }) => markdown())
  },
  { name: "java", loader: () => import("./dist-LGRULZ2S.js").then(({ java }) => java()) },
  { name: "html", loader: () => import("./dist-RDLJXUBN.js").then(({ html }) => html()) },
  {
    name: "csharp",
    loader: () => import("./clike-IGZJ5XIP.js").then(
      ({ csharp }) => StreamLanguage.define(csharp)
    )
  },
  {
    name: "sh",
    loader: () => import("./shell-CTYHTN2Z.js").then(({ shell }) => StreamLanguage.define(shell))
  },
  {
    name: "css",
    loader: () => import("./css-ZUYLGFDN.js").then(({ css }) => StreamLanguage.define(css))
  },
  {
    name: "scss",
    loader: () => import("./css-ZUYLGFDN.js").then(({ css }) => StreamLanguage.define(css))
  ...
  {
    name: "sass",
    loader: () => import("./sass-4MMOCWW4.js").then(({ sass }) => StreamLanguage.define(sass))
  },
  {
    name: "ruby",
    loader: () => import("./ruby-U72K4HM2.js").then(({ ruby }) => StreamLanguage.define(ruby))
  },
  {
    name: "python",
    loader: () => import("./python-QJF2TKRC.js").then(
      ({ python }) => StreamLanguage.define(python)
    )
  },
  {
    name: "xml",
    loader: () => import("./xml-HG25EH6A.js").then(({ xml }) => StreamLanguage.define(xml))
  },
  {
    name: "yaml",
    loader: () => import("./yaml-EXQ5LDHR.js").then(({ yaml }) => StreamLanguage.define(yaml))
  },
  {
    name: "golang",
    loader: () => import("./go-4TXCPOUV.js").then(({ go }) => StreamLanguage.define(go))
  },
  { name: "text", loader: () => {
  } },
  { name: "batch", loader: () => {
    ...
    config.readOnly ? [] : lineNumbers({
      domEventHandlers: {
        mousedown: (editorView, lineInfo) => {
          ...
          }), isHighlighted ? editorView.dispatch({ effects: removeLineHighlight.of(line.from) }) : editorView.dispatch({ effects: addLineHighlight.of(line.from) }), config?.onHighlightChange && config.onHighlightChange(editorView.state.toJSON(highlightState).highlight), true;
        }
      }
    }),
    highlightTheme
...
var CodeMirrorProxy = (0, import_react3.forwardRef)(
  function(props, ref) {
    const {
      ...
      value,
      ...codeMirrorProps
    } = props, themeCtx = useRootTheme(), codeMirrorTheme = useCodeMirrorTheme(), [editorView, setEditorView] = (0, import_react3.useState)(void 0), themeExtension = useThemeExtension(), fontSizeExtension = useFontSizeExtension({ fontSize: 1 }), languageExtension = useLanguageExtension(languageMode), highlightLineExtension = (0, import_react3.useMemo)(
      () => highlightLine({
        onHighlightChange,
        readOnly,
        theme: themeCtx
...
//# sourceMappingURL=CodeMirrorProxy-LEWLZ45L.js.map
